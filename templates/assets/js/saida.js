...
$(document).ready(function() {
  ...
  function produtosSelecionar(estoques) {
      ...
      validEstoques.forEach(function (estoque) {
           var optionValor = `${estoque.local_estoque_id};${estoque.lote};${estoque.nome};${estoque.estoque}`;
           var optionTexto = `${estoque.lote} - ${estoque.nome} Qnt.: ${estoque.estoque} Val.: ${estoque.vencimento} ${estoque.fornecedor}`;
 ...
 function atualizarCampoSelecionado(cod) {
     var $selecionadoCampo = $('#produtoSelecionar');
     $selecionadoCampo.empty(); // Limpa o selectField
     ...
     var estoquesFiltrados = cod ? estoques.filter(function (estoque) {
         return estoque.cod === cod;
