            ...
            style='max-width:300px' >
                <div class="card" style='position:relative;'>
                    ...
                    <i  style='position:absolute;font-size:120px;z-index:4;opacity:0.2;bottom:0;right:0;' class="fa-solid fa-tablets"></i>
                       ...
                       <div class='d-flex' style='gap:10px;'> <a data-link="entrada/editar/${item.registro_id}" data-id="${item.registro_id}" data-nome="${item.nome}" data-quantidade="${item.quantidade}" class="text-primary editarEntrada"><i class="icone fa-solid fa-pen"></i></a>
